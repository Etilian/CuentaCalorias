 ...
 * [caloriasFragment.OnFragmentInteractionListener] interface
...
class caloriasFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        textView11.text = (activity as MainActivity).consultaPersona().toString()
        textView9.text = (activity as MainActivity).consultaPerfil().toString()

        buttonReset.setOnClickListener {
            (activity as MainActivity).pasarDia()
            textView11.text = "0"
        }
    }
